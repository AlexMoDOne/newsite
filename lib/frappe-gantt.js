var Gantt = function () {
    ...
    var e = {
        ...
        format(e, i = "DD.MM.YYYY HH:mm:ss.SSS", n = "en") {
            ...
            let r = i;
            const h = [];
            return Object.keys(o).sort((t, e) => e.length - t.length).forEach(t => {
        ...
        add(t, e, s) {
            e = parseInt(e, 10);
            const i = [t.getFullYear() + ("year" === s ? e : 0), t.getMonth() + ("month" === s ? e : 0), t.getDate() + ("day" === s ? e : 0), t.getHours() + ("hour" === s ? e : 0), t.getMinutes() + ("minute" === s ? e : 0), t.getSeconds() + ("second" === s ? e : 0), t.getMilliseconds() + ("millisecond" === s ? e : 0)];
            return new Date(...i)
        },
        start_of(t, e) {
            const s = {
            ...
            const n = [t.getFullYear(), i("year") ? 0 : t.getMonth(), i("month") ? 1 : t.getDate(), i("day") ? 0 : t.getHours(), i("hour") ? 0 : t.getMinutes(), i("minute") ? 0 : t.getSeconds(), i("second") ? 0 : t.getMilliseconds()];
            return new Date(...n)
        },
        clone(t) {
    ...
    }), i.closest = ((t, e) => e ? e.matches(t) ? e : i.closest(t, e.parentNode) : null), i.attr = ((t, e, s) => {
    ...
    class o {
        ...
        prepare_values() {
            this.invalid = this.task.invalid, this.height = this.gantt.options.bar_height, this.x = this.compute_x(), this.y = this.compute_y(), this.corner_radius = this.gantt.options.bar_corner_radius, this.duration = e.diff(this.task._end, this.task._start, "hour") / this.gantt.options.step, this.width = this.gantt.options.column_width * this.duration, this.progress_width = this.gantt.options.column_width * this.duration * (this.task.progress / 100) || 0, this.group = n("g", {
        ...
        draw_bar() {
            ...
            }), a(this.$bar, "width", 0, this.width), this.invalid && this.$bar.classList.add("bar-invalid")
        }
        draw_progress_bar() {
        ...
        draw_resize_handles() {
            ...
            n("rect", {
                ...
                class: "handle left",
                append_to: this.handle_group
            }), this.task.progress && this.task.progress < 100 && (this.$handle_progress = n("polygon", {
        ...
        show_popup() {
            ...
            const t = e.format(this.task._start, "D MMM", this.gantt.options.language) + " - " + e.format(e.add(this.task._end, -1, "second"), "D MMM", this.gantt.options.language) + e.format(e.add(this.task._end, -1, "second"), " YYYY", this.gantt.options.language);
        ...
        compute_x() {
            const {
                step: t,
                column_width: s
            } = this.gantt.options, i = this.task._start, n = this.gantt.gantt_start;
    ...
    class r {
        ...
        calculate_path() {
            ...
            for (; e();) t -= 10;
            const s = this.gantt.options.header_height + this.gantt.options.bar_height + (this.gantt.options.padding + this.gantt.options.bar_height) * this.from_task.task._index + this.gantt.options.padding,
    ...
    class h {
        ...
        make() {
            ...
            this.hide(), this.title = this.parent.querySelector(".title"), this.subtitle = this.parent.querySelector(".subtitle"), this.progress = this.parent.querySelector(".progresss"), this.pointer = this.parent.querySelector(".pointer")
        }
        show(t) {
            ...
            else this.title.innerHTML = t.title, this.subtitle.innerHTML = t.subtitle,this.progress.innerHTML = "Завершено на " + t.task.progress + "%", this.parent.style.width = this.parent.clientWidth + "px";
            let s;
    ...
    class p {
        ...
        setup_tasks(t) {
            this.tasks = t.map((t, s) => {
                ...
                if (!t.start && t.end && (t._start = e.add(t._end, -2, "day")), t.start && !t.end && (t._end = e.add(t._start, 2, "day")), e.get_date_values(t._end).slice(3).every(t => 0 === t) && (t._end = e.add(t._end, 24, "hour")), t.start && t.end || (t.invalid = !0), "string" == typeof t.dependencies || !t.dependencies) {
                    let e = [];
        ...
        setup_date_values() {
            this.dates = [];
            let t = null;
            for (; null === t || t < this.gantt_end;) t = t ? this.view_is(d.YEAR) ? e.add(t, 1, "year") : this.view_is(d.MONTH) ? e.add(t, 1, "month") : e.add(t, this.options.step, "hour") : e.clone(this.gantt_start), this.dates.push(t)
        }
        bind_events() {
        ...
        setup_layers() {
            ...
            for (let e of t) this.layers[e] = n("g", {
                class: e,
                append_to: this.$svg
            })
        }
        ...
        make_grid_rows() {
            ...
            for (let o of this.tasks) n("rect", {
                x: 0,
                y: a,
                width: s,
                height: i,
        ...
        make_grid_ticks() {
            ...
            for (let a of this.dates) {
                let o = "tick";
                this.view_is(d.DAY) && 1 === a.getDate() && (o += " thick"), this.view_is(d.WEEK) && a.getDate() >= 1 && a.getDate() < 8 && (o += " thick"), this.view_is(d.MONTH) && (a.getMonth() + 1) % 3 == 0 && (o += " thick"), n("path", {
                    d: `M ${t} ${s} v ${i}`,
                    class: o,
                    append_to: this.layers.grid
        ...
        bind_bar_events() {
            let t = !1,
                ...
                o = null,
                r = [];
            this.bar_being_dragged = null, i.on(this.$svg, "mousedown", ".bar-wrapper, .handle", (h, d) => {
                const p = i.closest(".bar-wrapper", d);
                d.classList.contains("left") ? n = !0 : d.classList.contains("right") ? a = !0 : d.classList.contains("bar-wrapper") && (t = !0), p.classList.add("active"), e = h.offsetX, s = h.offsetY;
                const _ = [o = p.getAttribute("data-id"), ...this.get_all_dependent_tasks(o)];
                r = _.map(t => this.get_bar(t)), this.bar_being_dragged = o, r.forEach(t => {
                    const e = t.$bar;
                ...
                r.forEach(e => {
                    const s = e.$bar;
                    s.finaldx = this.get_snap_position(i), n ? o === e.task.id ? e.update_bar_position({
                        x: s.ox + s.finaldx,
                ...
                this.bar_being_dragged = null, r.forEach(t => {
        ...
        get_snap_position(t) {
            let e, s, i = t;
            return s = this.view_is(d.WEEK) ? i - (e = t % (this.options.column_width / 7)) + (e < this.options.column_width / 14 ? 0 : this.options.column_width / 7) : this.view_is(d.MONTH) ? i - (e = t % (this.options.column_width / 30)) + (e < this.options.column_width / 60 ? 0 : this.options.column_width / 30) : i - (e = t % this.options.column_width) + (e < this.options.column_width / 2 ? 0 : this.options.column_width)
        }
        unselect_all() {
